  ...
  for (I = 0; I <= N - 1; I++)
    {
      ...
      ALUNO[I].DADO.SALA = Console::ReadLine();
      Console::Write("Informe a serie......: ");
      ALUNO[I].DADO.SERIE = Console::ReadLine();
      Console::WriteLine();
  ...
  for (I = 0; I <= N - 1; I++)
    {
      ...
      Console::Write(ALUNO[I].DADO.SALA);
      Console::SetCursorPosition(47, I + 5);
      Console::Write(ALUNO[I].DADO.SERIE);
      Console::SetCursorPosition(54, I + 5);
